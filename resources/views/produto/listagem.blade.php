...
<div class="w3-container">
  <table class="w3-table-all">
    <thead>
      <a href="{{ action('ProdutoController@create') }}" class="" style="margin-left: 92%">
            ...
            <td>
              <div class="w3-dropdown-hover">
                ...
                <div class="w3-dropdown-content w3-bar-block w3-border">
                  <a href="{{ action('ProdutoController@edit',['id' => encrypt($produto->id)]) }}" class="w3-bar-item w3-button"> <i class="fa fa-edit"></i> editar</a>
